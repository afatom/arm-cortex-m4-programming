...
/*Initialize and reset GPIO driver APIs */
void GPIO_Init(GPIO_Handle_t *handle);
void GPIO_Reset(GPIO_RegDef_t *pGPIOx); /*reset gpio port to default state (via RCC reset register)*/
/*GPIO driver clock configuration */
