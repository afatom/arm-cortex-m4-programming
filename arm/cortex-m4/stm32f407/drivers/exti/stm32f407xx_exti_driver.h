...
#define EXTI                 ((struct exti_regs*)HAL_EXTI_BASE_ADDRESS)
...
void exti_driver_init(struct exti_driver *exti);
void exti_driver_deinit(struct exti_driver *exti);
//void exti_driver_init_PeriClkCtrl(exti_driver *handle, U8 cmd); should be static in c file
void exti_driver_gpio_irq_enable(struct exti_driver *exti, U8 gpio_port, U8 gpio_pin, void(*gpio_isr)(U8));
void exti_driver_gpio_irq_disable(struct exti_driver *exti, U8 gpio_port, U8 gpio_pin);
