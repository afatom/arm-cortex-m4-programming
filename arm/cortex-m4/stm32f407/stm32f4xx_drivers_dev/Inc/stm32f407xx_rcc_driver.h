 ...
 */
#define SPI_1_PCLK_EN()			(RCC_DRIVER->rcc_regs.APB2ENR |= (1 << 12))  /* SPI1 clock enable */
#define SPI_2_PCLK_EN()			(RCC_DRIVER->rcc_regs.APB1ENR |= (1 << 14))  /* SPI2 clock enable */
#define SPI_3_PCLK_EN()			(RCC_DRIVER->rcc_regs.APB1ENR |= (1 << 15))  /* SPI3 clock enable */

#define SPI_4_PCLK_EN()			(RCC_DRIVER->rcc_regs.APB2ENR |= (1 << 13))  /* SPI3 clock enable */
#define SPI_5_PCLK_EN()			(RCC_DRIVER->rcc_regs.APB2ENR |= (1 << 20))  /* SPI3 clock enable */
#define SPI_6_PCLK_EN()			(RCC_DRIVER->rcc_regs.APB2ENR |= (1 << 21))  /* SPI3 clock enable */

/*
 * Clock disable macros for SPIx peripherals
 */
#define SPI_1_PCLK_DI()			(RCC_DRIVER->rcc_regs.APB2ENR &= ~(1 << 12))  /* SPI1 clock disable */
#define SPI_2_PCLK_DI()			(RCC_DRIVER->rcc_regs.APB1ENR &= ~(1 << 14))  /* SPI2 clock disable */
#define SPI_3_PCLK_DI()			(RCC_DRIVER->rcc_regs.APB1ENR &= ~(1 << 15))  /* SPI3 clock disable */

#define SPI_4_PCLK_DI()			(RCC_DRIVER->rcc_regs.APB2ENR &= ~(1 << 13))  /* SPI3 clock enable */
#define SPI_5_PCLK_DI()			(RCC_DRIVER->rcc_regs.APB2ENR &= ~(1 << 20))  /* SPI3 clock enable */
#define SPI_6_PCLK_DI()			(RCC_DRIVER->rcc_regs.APB2ENR &= ~(1 << 21))  /* SPI3 clock enable */
