...
typedef volatile uint32_t _vou32;
typedef volatile uint64_t _vou64;
typedef volatile uint16_t _vou16;
typedef volatile uint8_t  _vou8;



#define HAL_ENABLE                     (1)
#define HAL_DISABLE                    (0)
#define HAL_CLK_ENABLE   (HAL_ENABLE)
#define HAL_CLK_DISABLE   (HAL_DISABLE)
#define HAL_SET              (HAL_ENABLE)
#define HAL_CLEAR            (HAL_DISABLE)
#define HAL_RESET            (HAL_DISABLE)
#define HAL_HIGH             (HAL_ENABLE)
#define HAL_LOW              (HAL_CLEAR)
...
/*********************************************************************
 *          GPIO Ports Names/IDs
 *********************************************************************/
#define GPIO_PORT_A_ID                      (0)
#define GPIO_PORT_B_ID                      (1)
#define GPIO_PORT_C_ID                      (2)
#define GPIO_PORT_D_ID                      (3)
#define GPIO_PORT_E_ID                      (4)
#define GPIO_PORT_F_ID                      (5)
#define GPIO_PORT_G_ID                      (6)
#define GPIO_PORT_H_ID                      (7)
#define GPIO_PORT_I_ID                      (8)
#define GPIO_PORT_J_ID                      (9)
#define GPIO_PORT_K_ID                      (10)
...
#define HAL_SYSTEM_MEM_BASE_ADDRESS           (0x1FFF0000U) //ROM Area
...
#define HAL_GPIO_J_BASE_ADDRESS                (HAL_AHB1_BUS_PERIPH_BASE_ADDRESS  + 0x2400)
#define HAL_GPIO_K_BASE_ADDRESS                (HAL_AHB1_BUS_PERIPH_BASE_ADDRESS  + 0x2800)
...
#define HAL_SPI_1_BASE_ADDRESS                 (HAL_APB2_BUS_PERIPH_BASE_ADDRESS + 0x3000)
#define HAL_SPI_4_BASE_ADDRESS                 (HAL_APB2_BUS_PERIPH_BASE_ADDRESS + 0x3400)

#define HAL_SYSCFG_BASE_ADDRESS                (HAL_APB2_BUS_PERIPH_BASE_ADDRESS + 0x3800)
#define HAL_EXTI_BASE_ADDRESS                  (HAL_APB2_BUS_PERIPH_BASE_ADDRESS + 0x3C00)
#define HAL_SPI_5_BASE_ADDRESS                 (HAL_APB2_BUS_PERIPH_BASE_ADDRESS + 0x5000)
#define HAL_SPI_6_BASE_ADDRESS                 (HAL_APB2_BUS_PERIPH_BASE_ADDRESS + 0x5400)
...
#define CLK_ENABLE            ((u8)1)
#define PER_CLK_EN            (CLK_ENABLE)
#define SPI_CLK_EN            (CLK_ENABLE)




/************************************************************************************
*  EXTI Lines IRQ number Deffs
*  see : Table 61. Vector table for STM32F405xx/07xx in RM
*
**************************************************************************************/
//EXTI Line0 interrupt
#define EXTI_LINE_0_IRQ_VECT_POS							(6)
#define EXTI_LINE_1_IRQ_VECT_POS							(7)
#define EXTI_LINE_2_IRQ_VECT_POS							(8)
#define EXTI_LINE_3_IRQ_VECT_POS							(9)
#define EXTI_LINE_4_IRQ_VECT_POS							(10)
#define EXTI_LINE_9_5_IRQ_VECT_POS							(23) //EXTI Line[9:5] interrupts
#define EXTI_LINE_15_10_IRQ_VECT_POS							(40) //EXTI Line[15:10] interrupts


/* IRQ__ For EXTI */
#define IRQ__EXTI_LINE_0_VECT_POS								(6)
#define IRQ__EXTI_LINE_1_VECT_POS								(7)
#define IRQ__EXTI_LINE_2_VECT_POS								(8)
#define IRQ__EXTI_LINE_3_VECT_POS								(9)
#define IRQ__EXTI_LINE_4_VECT_POS								(10)
#define IRQ__EXTI_LINE_9_5_VECT_POS								(23) //EXTI Line[9:5] interrupts
#define IRQ__EXTI_LINE_15_10_VECT_POS							(40) //EXTI Line[15:10] interrupts
/* SPI IRQs */
#define IRQ__SPI_1_GLOBAL_VECT_POS                              (35)  /* SPI1 global interrupt */
#define IRQ__SPI_2_GLOBAL_VECT_POS                              (36)  /* SPI2 global interrupt */
#define IRQ__SPI_3_GLOBAL_VECT_POS                              (51)  /* SPI3 global interrupt */
...
// IRQ priority levels supported by NVIC
...
typedef struct {
	volatile U32 ISER_REGTABLE[8];			/* Interrupt Set-enable Registers   */
	volatile U32 RESERVED1[24];				/*----------------------------------*/
	volatile U32 ICER_REGTABLE[8];			/* Interrupt Clear-enable Registers */
	volatile U32 RESERVED2[24];				/*----------------------------------*/
	volatile U32 ISPR_REGTABLE[8];			/* Interrupt Set-pending Registers  */
	volatile U32 RESERVED3[24];				/*----------------------------------*/
	volatile U32 ICPR_REGTABLE[8];			/* Interrupt Clear-pending Registers */
	volatile U32 RESERVED4[24];				/*----------------------------------*/
	volatile U32 IABR_REGTABLE[8];			/* Interrupt Active Bit Registers */
	volatile U32 RESERVED5[56];				/*----------------------------------*/
	volatile U32 IPR_REGTABLE[60];			/* Interrupt Priority Registers */
...
#define pNVIC_ISER0_REG         ((volatile U32*)(0xE000E100))
#define pNVIC_ISER1_REG         ((volatile U32*)(0xE000E104))
#define pNVIC_ISER2_REG         ((volatile U32*)(0xE000E108))
#define pNVIC_ISER3_REG         ((volatile U32*)(0xE000E10C))


#define pNVIC_ICER0_REG         ((volatile U32*)(0XE000E180))
#define pNVIC_ICER1_REG         ((volatile U32*)(0XE000E184))
#define pNVIC_ICER2_REG         ((volatile U32*)(0XE000E188))
#define pNVIC_ICER3_REG         ((volatile U32*)(0XE000E18C))

#define pNVIC_IPR0_REG          ((volatile U32*)(0xE000E400))

#define pNVIC_IPR1_REG          ((volatile U32*)(0xE000E400U + 0x04))
